...
app.post('/api/create_link_token', async (req, res, next) => {
  ...
  if (req.body.address === 'localhost') {
    console.log('[create_link_token] Handling iOS')
    payload = {
    ...
    console.log('[create_link_token] Handling Android')
...
app.post('/api/exchange_public_token', async (req, res, next) => {
  console.log(`[exchange_public_token] Exchanging Public Token`)
...
app.post('/api/balance', async (req, res, next) => {
  console.log('[balance] Retrieving balance')
